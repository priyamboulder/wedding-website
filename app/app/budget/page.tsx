...
export default function CoupleBudgetPage() {
  ...
  function handleSelect(sel: WorkspaceSelection) {
    ...
    if (sel.type === "documents") { router.push("/documents"); return; }
    if (sel.type === "events") { router.push("/workspace/events"); return; }
    if (sel.type === "schedule") { router.push("/workspace/schedule"); return; }
