      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-1.5 text-[14px] text-stone-600">
            Earnings, fees, and payment history for {SELLER.shopName}.
          </p>
        </div>
      ...
      <Card tone="ivory">
        <div className="grid grid-cols-1 divide-x divide-y divide-[rgba(44,44,44,0.06)] sm:grid-cols-2 sm:divide-y-0 lg:grid-cols-4">
          ...
          <EarningsCell
            ...
            sub="October earnings"
          />
          <EarningsCell
            label="Year to date"
            value={moneyWhole(P.yearToDate)}
            sub="Gross sales in 2026"
          />
          <EarningsCell
        ...
        >
          <div>
            ...
            <p className="mt-0.5 text-[12.5px] text-stone-600">
              Funds clear to {P.settings.methodDetail} in 1–2 business days.
            </p>
          </div>
          <button
            type="button"
          ...
          >
            Request payout <span aria-hidden>→</span>
          </button>
        </div>
      </Card>
    </section>
...
function FeeBreakdown() {
  const B = SELLER_PAYOUTS.monthEarningsBreakdown;
  ...
  return (
    <section>
      <SectionHeading
        title={`${SELLER_PAYOUTS.monthLabel} earnings breakdown`}
        action={
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.4fr_1fr]">
        ...
        <div className="flex flex-col gap-3">
          <FeeExplainer
            ...
            detail="Charged on product price only — shipping is not subject to the marketplace fee. This is Ananya's revenue."
          />
          <FeeExplainer
            glyph="⌛"
            title="Payment processing"
            detail="Stripe standard — 2.9% of the transaction plus $0.30 per charge."
          />
          <FeeExplainer
            glyph="📮"
  ...
  return (
    <section>
      <SectionHeading
        ...
        count={SELLER_PAYOUTS.history.length}
        action={
          <button
            type="button"
      ...
      <Card tone="ivory">
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-[13px]">
            ...
            <tbody>
              {SELLER_PAYOUTS.history.map((row) => (
...
function PayoutSettings() {
  const S = SELLER_PAYOUTS.settings;
  return (
    <section>
      ...
      <Card tone="ivory">
        <div className="divide-y" style={{ borderColor: HAIRLINE }}>
          ...
          <SettingRow
            ...
            value={S.schedule}
            sub={S.scheduleOptions.filter((o) => o !== S.schedule).join(" · ")}
            action="Change"
          />
          <SettingRow
          ...
          <SettingRow
            ...
            value={
              <span className="inline-flex items-center gap-2">
                ...
                >
                  <span aria-hidden>✓</span> W-9 on file
                </span>
              </span>
            }
            sub={`1099-K threshold ${money(S.form1099KThreshold, { decimals: false })} — ${
...
function TaxSummary() {
  const T = SELLER_PAYOUTS.tax;
  return (
    <section>
      <SectionHeading
        title="Tax summary · 2026"
        action={
          <button
            type="button"
            className="inline-flex h-8 items-center gap-1.5 rounded-md border bg-white px-3 text-[12.5px] text-[#2C2C2C] transition-colors hover:bg-[#FBF3E4]"
            style={{ borderColor: "rgba(44,44,44,0.12)" }}
          >
            <span aria-hidden>⤓</span> Download for accountant
          </button>
        }
      />
      <Card tone="ivory">
        <div className="p-6">
          ...
          >
            ...
            <p className="text-[12.5px] leading-snug text-stone-600">
              ...
              generated for you in January 2027. Hand this summary to your
