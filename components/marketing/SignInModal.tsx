    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] flex items-end justify-center px-0 sm:items-center sm:px-4"
        ...
        >
          <motion.div
            ...
            className="relative w-full sm:max-w-[480px] bg-[#F7F5F0] px-5 py-8 sm:px-8 sm:py-10 md:px-12 md:py-14 overflow-y-auto rounded-t-xl sm:rounded-none"
            style={{
              maxHeight: "100dvh",
              ...
              <>
                <div className="text-center">
                  ...
                  <h2
                    ...
                    style={{ fontFamily: DISPLAY, fontSize: "clamp(24px, 5vw, 38px)", lineHeight: 1.1, letterSpacing: "-0.01em", fontWeight: 400 }}
                  >
                    {copy.headline}
                  </h2>
                ...
                <div className="mt-5 sm:mt-8 flex items-center gap-1 border-b border-[#1C1917]/10" role="tablist" aria-label="Sign in or create account">
                ...
                <div className="my-4 sm:my-6 flex items-center gap-3 text-[11px] uppercase text-[#A8998A]" style={{ letterSpacing: "0.25em" }}>
                ...
                <p className="mt-5 sm:mt-8 text-center text-[11px] text-[#A8998A]" style={{ lineHeight: 1.6 }}>
...
function SignInForm({
  ...
  return (
    <form
      className="mt-5 sm:mt-7 flex flex-col gap-3 sm:gap-4"
      onSubmit={async (e) => {
        e.preventDefault();
        setLoading(true);
